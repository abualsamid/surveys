...
export const languageText = {
  ...
  "Admin_Choose_Language" : {
    "en":"Please select your language to access the admin dashboard. Only authorized users will be able to proceed.",
    "es":"Por favor seleccione su idioma para acceder al panel de administración. Sólo los usuarios autorizados podrán proceder."
  },
  ...
  "Follows through on promises/requests" : {
  "en": "Follows through on promises/requests",
  "es": "Cumple con sus promesas/peticiones"
  },
  "In General" : {
    "en": "In General...",
    "es": "Por Lo General..."
